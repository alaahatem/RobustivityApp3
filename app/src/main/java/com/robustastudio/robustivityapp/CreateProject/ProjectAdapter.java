...
public class ProjectAdapter extends RecyclerView.Adapter<ProjectAdapter.ViewHolder> {
    ...
    public ProjectAdapter(List<String> project) {
        this.project = project;
    }

    @Override
    public ProjectAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.create_project_card,parent,false);
    ...
    public void onBindViewHolder(ProjectAdapter.ViewHolder holder, int position) {
        holder.item.setText(project.get(position));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            item=itemView.findViewById(R.id.engagement);
        }
    }
}
